...
public class SearchDataService {
    ...
    public String searchTableDataCSV(Optional<Integer> masterId, Optional<Integer> startTime, Optional<Integer> endTime) {
    ...
    public String multiAreaDataCSV(Optional<Integer> masterId, Optional<List<String>> itemName1, Optional<Integer> startTime, Optional<Integer> endTime) {

        JSONArray jsonArr_result = new JSONArray();

        List<SearchEntity> searchEntityList = searchEntityRepository.findByAreaMultipleCSV(masterId, itemName1, startTime, endTime);
        for (SearchEntity searchEntity : searchEntityList) {
            JSONObject result = new JSONObject();
            result.put("statName", searchEntity.getStatName());
            result.put("ItemCode1", searchEntity.getItemCode1());
